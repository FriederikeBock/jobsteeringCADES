...
#   ./create_job.sh $nEvents $energy $energy 2. 35. gfhcal_only pi- gfhcal_45deg_$energy\GeV 0 dd4hep 25 $overwriteoutput
#   ./create_job.sh $nEvents $energy $energy 2. 35. lfhcal_only pi- lfhcal_45deg_$energy\GeV 0 dd4hep 25 $overwriteoutput
done
